    ...
    <ul class="flex flex-wrap items-center gap-4 text-sm font-medium text-slate-200">
      ...
      <li class="relative group">
        ...
        <ul class="invisible group-hover:visible opacity-0 group-hover:opacity-100 absolute right-0 mt-2 w-56 rounded-2xl bg-[#1A1D27] border border-white/[0.07] p-2 shadow-2xl shadow-black/60 transition-all z-50">
          ...
          <!-- Overview -->
          <li>
            <router-link to="/destination" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-300 hover:bg-emerald-500/10 hover:text-emerald-300 transition group/item">
              <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-emerald-500/10 text-emerald-400 group-hover/item:bg-emerald-500/20 flex-shrink-0">
          ...
          <li class="my-1.5 border-t border-white/[0.06]"></li>

          <!-- Kigali -->
          <li>
            <router-link to="/kigali" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-300 hover:bg-emerald-500/10 hover:text-emerald-300 transition group/item">
              <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-emerald-500/10 text-emerald-400 group-hover/item:bg-emerald-500/20 flex-shrink-0">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
          ...
          <!-- North -->
          <li>
            <router-link to="/north" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-300 hover:bg-emerald-500/10 hover:text-emerald-300 transition group/item">
              <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-emerald-500/10 text-emerald-400 group-hover/item:bg-emerald-500/20 flex-shrink-0">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
          ...
          <!-- South -->
          <li>
            <router-link to="/south" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-300 hover:bg-emerald-500/10 hover:text-emerald-300 transition group/item">
              <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-emerald-500/10 text-emerald-400 group-hover/item:bg-emerald-500/20 flex-shrink-0">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
          ...
          <!-- West -->
          <li>
            <router-link to="/west" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-300 hover:bg-emerald-500/10 hover:text-emerald-300 transition group/item">
              <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-emerald-500/10 text-emerald-400 group-hover/item:bg-emerald-500/20 flex-shrink-0">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
          ...
          <!-- East -->
          <li>
            <router-link to="/east" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-300 hover:bg-emerald-500/10 hover:text-emerald-300 transition group/item">
              <span class="flex items-center justify-center w-7 h-7 rounded-lg bg-emerald-500/10 text-emerald-400 group-hover/item:bg-emerald-500/20 flex-shrink-0">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
